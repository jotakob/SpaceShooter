	...
	public function new(X:Float=0, Y:Float=0,?PlayerNumber:Int,?GamePad:FlxGamepad) 
	{
		...
		switch(playerNumber)
		{
			...
			case 1:
				...
				addWeapon(new Weapon(this, 0.20, 600, AssetPaths.bullet__png, AssetPaths.bullet__png, 5));
			case 2:
				myAnimationController = new AnimationController(x, y, this, "soldier");
				addWeapon(new Weapon(this, 0.1, 400, AssetPaths.bullet__png, AssetPaths.bullet__png, 10));
			default:
